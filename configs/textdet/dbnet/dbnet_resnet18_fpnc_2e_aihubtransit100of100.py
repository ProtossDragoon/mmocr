...
# dataset settings
train_list = [_base_.aihubtransit100of100_textdet_train]
val_list = [
    _base_.aihubtransit100of100_textdet_validation,
    _base_.icdar2015_textdet_test
]
test_list = [
    _base_.aihubtransit100of100_textdet_test,
...
test_evaluator = dict(
    ...
    metrics=dict(type='HmeanIOUMetric'),
    dataset_prefixes=[
        'AihubTransit100of100', 'AihubTransit100of100RandomSampled', 'IC15'
    ])
...
# Set the maximum number of epochs to 2, and validate the model every 1 epochs
