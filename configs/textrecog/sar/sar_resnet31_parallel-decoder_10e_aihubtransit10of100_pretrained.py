...
# dataset settings
train_list = [_base_.aihubtransit10of100_textrecog_train]
val_list = [
    _base_.aihubtransit10of100_textrecog_test, _base_.icdar2015_textrecog_test
]
test_list = [
    _base_.aihubtransit10of100_textrecog_test,
    _base_.aihubtransit_textrecog_sampled4vis1, _base_.icdar2015_textrecog_test
]
...
test_evaluator = dict(
    ...
    dataset_prefixes=[
        'AihubTransit10of100', 'AihubTransit100of100Sampled', 'IC15'
    ])
...
# Set the maximum number of epochs to 10, and validate the model every 2 epochs
